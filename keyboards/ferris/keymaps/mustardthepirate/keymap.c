...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x5_2(KC_TRNS, KC_TRNS, KC_COLN, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL, KC_CAPS, KC_PERC, S(KC_SCLN), KC_ESC, KC_TRNS, DF(8), KC_LGUI, KC_DEL, KC_BSPC, CW_TOGG, KC_TRNS, KC_TRNS, KC_TRNS, KC_EXLM, KC_TRNS, DF(0), KC_TRNS, RALT_T(KC_COMM), KC_RALT, KC_RGUI, KC_RCTL, KC_TRNS, KC_TAB, KC_NO, KC_TRNS),
